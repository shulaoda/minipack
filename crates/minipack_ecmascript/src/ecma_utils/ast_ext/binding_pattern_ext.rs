use oxc::{
  ...
  ast::ast::{
    self, ArrayAssignmentTarget, AssignmentTarget, AssignmentTargetMaybeDefault,
    AssignmentTargetRest, AssignmentTargetWithDefault, BindingPatternKind, ObjectAssignmentTarget,
  },
};
